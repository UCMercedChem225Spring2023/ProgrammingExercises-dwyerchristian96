...
!     will provide the number of basis functions and the particle mass.
!
...
!     Variable Declarations
      ...
      real::b=01,m,l=01        ! Potential: V(x) = 01*x !
!     real::b=10,m,l=01        ! Potential: V(x) = 10*x !
      logical::fail
...
!
!
!     Read in NDim and m from the command line.
!
      fail = .false.
